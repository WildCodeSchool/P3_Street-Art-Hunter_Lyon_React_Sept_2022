...
INSERT INTO artist (artist_name) VALUES ('Artiste inconnu'),('Vincent'),('Daryl'),('Younes'),('Gaelle');
-- -----------------------------------------------------
...
CREATE TABLE user (
  ...
  INSERT INTO user (id, firstname, lastname, scorepoint, pseudo, is_admin, email, hashedPassword)
VALUES
...
CREATE TABLE work (
  ...
  longitude DECIMAL(20,18) NULL DEFAULT NULL,
  latitude DECIMAL(20,18) NULL DEFAULT NULL,
