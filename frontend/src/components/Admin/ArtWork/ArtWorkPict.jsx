...
const rows = [
  createData("chemin de la photo...", 100, 9),
  createData("chemin de la photo...", 20, 4),
  createData("chemin de la photo...", 10, 8),
];
      ...
      <TableRow>
        <TableCell padding="checkbox">
          <Checkbox
            ...
            inputProps={{
              "aria-label": "select all pictures",
            }}
          />
        </TableCell>
    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography
          ...
          component="div"
        >
          <p className="font-main-font text-[2rem]">Photo Photo</p>
        </Typography>
      )}
...
export default function ArtworkPict() {
