...
function Step1({ setStep, step }) {
  ...
  return (
    <div className="absolute bottom-0 bg-fondStepper bg-no-repeat bg-contain bg-top bg-white  w-screen h-4/6 rounded-t-[15%] flex flex-col items-center justify-around ">
