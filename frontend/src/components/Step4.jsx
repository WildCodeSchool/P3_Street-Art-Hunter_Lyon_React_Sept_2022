  ...
  return (
    <div className="absolute bottom-0 bg-white w-screen h-4/6 rounded-t-[15%] flex flex-col items-center justify-around ">
      <div className="flex flex-col inset-x-0 bottom-0">
        <div className="absolute top-1 bg-step4 bg-top bg-contain h-[25vh] w-full bg-no-repeat mt-[1rem]" />
        <p className="font-main-font text-center text-2xl mt-[14rem] pr-12 pl-12">
          Inscriver vous des maintenant pour rejoindre la chasse !
        </p>
      ...
      <div className="flex justify-center items-center align-middle mt-[2rem] pt-[2.80rem]">
        <NavLink to="/inscription">
          <input
            type="submit"
            value="S'inscrire"
            className="bg-gradient-to-tl from-pink to-lightblue rounded-3xl font-main-font text-[30px] py-1 px-6 "
          />
        </NavLink>
      </div>
    </div>
