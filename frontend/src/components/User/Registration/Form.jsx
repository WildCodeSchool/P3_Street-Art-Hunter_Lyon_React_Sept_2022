    ...
    <div>
      ...
      {isLittleMobile && (
        <div className="flex flex-col  justify-center items-center  backdrop-blur-sm rounded-[3rem] mt-2 ml-2 w-[95%]">
          {doneinscr ? (
            ...
            <>
              <h1 className="text-white font-main-font text-4xl ">
                INSCRIPTION
              </h1>
              <form
                onSubmit={handleForm}
              ...
              >
                ...
                <label
                  className={`flex flex-col justify-center text-white ${
                    redForm.includes("pseudo") ? "mt-[0rem]" : "mt-3"
                  }`}
                >
                  Prénom
                  <div
                ...
                <label
                  className={`flex flex-col justify-center text-white ${
                    redForm.includes("firstname") ? "mt-[0rem]" : "mt-3"
                  }`}
                >
                  Nom
                  <div
                ...
                <label
                  className={`flex flex-col justify-center text-white ${
                    redForm.includes("lastname") ? "mt-[0rem]" : "mt-3"
                  }`}
                >
                  Adresse email
                  <div
                ...
                <label
                  className={`flex flex-col justify-center text-white ${
                    redForm.includes("email") ? "mt-[0rem]" : "mt-3"
                  }`}
                >
                  Mot de passe
                  <div
                ...
                <label
                  className={`flex flex-col justify-center text-white ${
                    redForm.includes("password") ? "mt-[0rem]" : "mt-3"
                  }`}
                >
                  Confirmer le mot le passe
                  <div
      ...
      {isTablet && (
        <div className="flex justify-center">
          <div className="flex flex-col  justify-center items-center  backdrop-blur-sm rounded-[3rem] ml-2 w-[80%] h-[80vh]">
            {doneinscr ? (
              ""
            ) : (
              <>
                <h1 className="text-white font-main-font text-7xl mb-4 mt-4">
                  INSCRIPTION
                </h1>
                <form
                  onSubmit={handleForm}
                  className="flex flex-col justify-center items-center mb-4 text-2xl"
                >
                  <label className="flex flex-col justify-center text-white w-full">
                    Pseudo
                    <div
                      className={`flex flex-row-reverse border rounded-[3rem] border-${
                        redForm.includes("pseudo") ? "red-700" : "white"
                  ...
                  <label
                    className={`flex flex-col justify-center text-white w-full ${
                      redForm.includes("pseudo") ? "mt-[0rem]" : "mt-5"
                    }`}
                  >
                    Prénom
                  ...
                  <button
                    type="submit"
                    className={`mt-[3rem] bg-gradient-to-tl from-pink to-lightblue rounded-3xl font-main-font text-5xl py-3 px-8 ${
                      redForm.includes("firstname") ? "mt-[0.2rem]" : "mt-6"
                    }`}
                  >
                    S'INSCRIRE
